...
(() => {
  ...
  var sunrise_request_default = {
    get,
    post
  };

  // api.js
  var getList = (params) => sunrise_request_default.get("/getList", params);
  var postList = (params) => sunrise_request_default.post("/postList", params);
  (() => __async(void 0, null, function* () {
    try {
      const postres = yield postList({
        method: "post"
      });
      console.log("\u6253\u5370***postres", postres);
      const getres = yield getList({ method: "get" });
